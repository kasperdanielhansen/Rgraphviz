...
clusterPlot <- function(x, y, ..., nodeLabels, centerNode, nodeShape,
    ...
    foo <- testPlot(x,g,nodeLabels, attrs, edgeCols, defEdgeCol,
                    nC, tC, ...)
    invisible(foo)
...
testPlot <- function(x, g, nodeLabels, attrs, edgeCols,
                     defEdgeCol, nC, tC, ...) {
