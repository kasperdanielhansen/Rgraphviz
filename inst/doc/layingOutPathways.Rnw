...
%\VignetteDepends{Rgraphviz, graph, geneplotter, fibroEset, hgu95av2}
...
\Rpackage{hgu95av2} data packages and the
...
require("hgu95av2")
data("fibroEset")
plotExpressionGraph(IMCAGraph, IMCAAttrs$LocusLink, exprs(fibroEset)[,1], hgu95av2LOCUSID, attrs=IMCAAttrs$defAttrs, subGList=IMCAAttrs$subGList, nodeAttrs=IMCAAttrs$nodeAttrs)
@
