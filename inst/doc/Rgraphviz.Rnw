...
argument which accepts a list of every subgraph.  The subgraphs in the
list must be named.

<<subGplot, fig=TRUE>>=
plot(g1, subGList=list(sg1=sg1, sg2=sg2, sg3=sg3))
@
...
plot(g1, subGList=list(sg1=sg1, sg2=sg2))
@
...
\section{Attributes for subgraphs}

Subgraphs have their attributes set via the argument
\Robject{subGAttrs}, which operates identically to \Robject{nodeAttrs}
except that the name of the appropriate subgraph is used and not a node.
